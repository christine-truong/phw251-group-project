...
This table displays the number and percentage of participants who reported having mental illness, as well as the number of participants who reported having no mental illness, separated by racial background of the participants.
...
Based on our results from the analysis of our data, the impact of race on diagnosed mental illness status is inconclusive. This conclusion is supported by semi-conflicting information given by Table 2 and Figure 1; with the exception of the two non-informative racial-category responses of "Don't know" and "Refused" in Table 2, smokers who identified as "Other" appear to have the greatest percentage of mental illness cases, followed by smokers who identified as "American Indian or Alaskan Native." In Figure 1, smokers who identified as "Other" and reported having mental illness had the greatest average number of pack-years, but those who identified as "White" and reported mental illness followed more closely behind in average number of pack-years than "American Indian or Alaskan Native," which also had a significant average number of pack-years compared to other races. The observation of the "White" race category having a greater average number of pack-years than "American Indian or Alaskan Native" in Figure 1 is thus notable because it disrupts the slight trend we see in both Table 2 and Figure 1 of the "Other" and "American Indian or Alaskan Native" race categories having an association with mental illness among smokers. This interesting observation warrants further research into the relationship between race and reported mental illness outcomes, with the recommendation that potential confounders and sources of potential bias are accounted for, which were not in this analysis. For example, given the data we have here, we do not know how accurate participants' reports of diagnosed mental illnesses are, which may skew the length of the bars per race by reported mental illness status category in Figure 1.
