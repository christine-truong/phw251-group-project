...
\newline
The desired type/format for all variables of interest except for SMOK6NUM is character. On the other hand, the desired type/format for SMOK6NUM is numeric. We will not need to convert any columns to numeric or other type; although HOWMANY mostly consists of integers ranging from 0 to 100, the value of "100 or more cigarettes" suggests that HOWMANY should be a character instead of numeric in order to account for it.
