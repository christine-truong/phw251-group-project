...
The data source for this project is the 2011 California Smokers Cohort (CSC), which is a part of the California Tobacco Surveys (CTS) that aimed to investigate statewide tobacco use and behaviors among smokers to assess the effectiveness of smoking cessation strategies in California. It was sponsored by the California Department of Public Health (CDPH), and the data was collected between July 8, 2011 and December 8, 2011.
\newline

**How does the dataset relate to the group problem statement and question?**

For this project, we aim to investigate how tobacco use impact mental illness among smokers in California in 2011. We also aim to explore how race and location of cigarette purchase can impact disease status. (NEED TO ADD STEPS ON DATA MANIPULATION)
