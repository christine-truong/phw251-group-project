...
kable(table_smoker_howmany, 
      ...
      align='lcccc', 
      caption="Mean No. of Cigarettes Smoked In the Past Month Based on Buying Location",
...
kable(table_nervous_othmenill, 
      ...
      align='lcccc', 
      caption="Number of Smokers Per Level of Anxiety Feelings By Mental Illness Status",
      format.args=list(big.mark=","))%>%
  kable_styling(latex_options = "HOLD_position")
