...
kable(table_smoker_wherebuy, 
      ...
      align='lcccc', 
      caption="Frequencies Per Cigarette-buying Location",
...
kable(table_smoker_howmany, 
      ...
      align='lcccc', 
      caption="Average Number of Cigarettes Smoked In the Past 30 Days Based on Cigarette-buying Location",
...
#better visualization of the table. Finally, we ordered the string values of
#`nervous` by converting the variable into a factor and arranging them from lowest
#to highest. The values being ordered range from lowest levels of nervousness/
#anxiousness/feeling on edge (i.e., "Not at all") to highest levels
...
kable(table_nervous_othmenill, 
      booktabs=T, 
      col.names=c("Level of Nervousness/Anxiousness/Feeling On Edge", "No Diagnosed Mental Illness", "Diagnosed Mental Illness"),  
      align='lcccc', 
      caption="Number of Smokers Per Level of Nervousness/Anxiousness/Feeling On Edge By Mental Illness Status",
      format.args=list(big.mark=","))%>%
  kable_styling(latex_options = "HOLD_position")
