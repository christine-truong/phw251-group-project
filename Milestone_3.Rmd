...
race_data_2 <- race_data %>%
  mutate(race = case_when(race01 == "Yes" ~ "White",
        ...
        race05 == "Yes" ~ "Filipino",
        race06 == "Yes" ~ "Korean",
        race07 == "Yes" ~ "Vietnamese",
        race08 == "Yes" ~ "Other Asian or Pacific Islander",
        race09 == "Yes" ~ "American Indian or Alaskan Native",
        race10 == "Yes" ~ "Mexican",
        race11 == "Yes" ~ "Hispanic/Latio",
        race12 == "Yes" ~ "Asian Indian",
        race13 == "Yes" ~ "Other",
        race14 == "Yes" ~ "Refused",
