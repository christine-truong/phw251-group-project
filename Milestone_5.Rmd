...
This bar graph explores the relationship between frequencies per cigarette purchase location and reported mental illness status among smokers in the 2011 California Smokers Cohort study.
...
Based on our results from the analysis on our data, the impact of race on diagnosed mental illness status is inconclusive. This conclusion is supported by the conflicting information given by Table 2 and Figure 1, in that smokers who identified as "White" had the highest number of reported mental illness diagnoses, but the race category of "Other" surpassed "White" in terms of average number of pack-years to quantify tobacco consumption, as shown in Figure 1. However, it is worth mentioning that the "White" race category's average number of pack-years is very close to that of "Other"; the two race categories' bar lengths are similar in length, as seen in Figure 1. This point of interest suggests for further research into the relationship between race and mental illness outcomes with the recommendation that the analyses rule out confounding factors and other factors that may bias the results, which were not covered in this analysis. For example, given the data we have here, we do not know how accurate participants' reports of diagnosed mental illnesses are, which may influence the length of the bars per race by reported mental illness status category in Figure 1.

In addition our group has concluded that there is a possible association between cigarette purchasing locations and mental illness outcomes. Although there were few cases of reported mental illness diagnoses compared to that for no mental illness diagnoses, the highest numbers of reported mental illness diagnoses were for the cigarette-buying locations of convenience or gas stations, as well as tobacco discount stores. Again though, further research and strict analyses must be performed in order to minimize confounding and factors that may distort the relationship between cigarette purchasing locations and mental illness outcomes.
