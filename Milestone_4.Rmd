...
##Determining Pack-years as New Variables
...
avg_pack_years_race_heartdis <- joined_smoking_df %>%
  ...
  mutate(avg_pack_years = sum(pack_years)/n())
...
_**Pack-years by Race and Disease (Four Graphs)**_
...
_**Interpretation of the Four Graphs of Pack-years by Disease:**_
\newline
