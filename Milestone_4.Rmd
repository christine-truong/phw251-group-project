...
_**Bar Graph: Average Pack-years by Race and Mental Illness**_
```{r bar graph of cigarette pack-years by race and mental illness, fig.width=8, fig.height=5, message=FALSE, warning=FALSE}
...
\newline 
\newline 
\newline _**Interpretation of Average Pack-years by Race and Mental Illness Bar Graph:**_
\newline
\newline
...
_**Bar Graph: Cigarette Purchase Location and Mental Illness**_
```{r bar graph of frequencies by cigarette purchase location and mental illness, fig.width=8, fig.height=5}
...
#We chose to create a stack bar graph in order to more easily compare the
#mental illness statuses reported by smokers for each cigarette
#purchase location (since the frequencies are small), as well as showcase
#the frequency that cigarettes were purchased at each location by smokers.
