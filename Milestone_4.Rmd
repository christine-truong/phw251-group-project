...
```{r kable table of cigarette pack-years by disease}

#Table for avg pack-years per disease for those who have them
...
#Table for avg pack-years per disease for those who do not have them
...
kable(t_avg_pack_years_no_disease, 
      ...
      col.names=c("Disease", "Average Pack-years"),  
      align='lcccc', 
      caption= 'Average Pack-years Among Smokers Responding "No" to a Disease') %>%
      kable_styling(full_width = T)

#I created another table with all diseases present with yes/no statuses and with unique
#combinations
...
```
_**Interpretation of the Three Tables of Average Pack-years by and Disease:**_
\newline
Among those individuals that have reported the presence of the diseases of interest, those with Diabetes have the highest average number of pack years. While those with mental illness have the lowest number of pack years. Among those without reported diseases those without mental illness have the highest average pack years. Those without asthma had the lowest average pack years. When looking at all diseases indivduals with heart disease and diabetes as well as heart disease and mental illness have the highest average pack years over all combinations of disease. 
